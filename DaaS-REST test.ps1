...
$secretPath = "c:\secrets\sefrance.csv" # in this format: customerId,citrixAPIKey,secretKey. If this is not present, user will have to logon explicitely
$region='eu' # eu, us or ap are supported, default is eu

$Scriptpath ="C:\Users\vincent.VITUALITY\Documents\#GitHub\DaaS-Rest"
...
(Invoke-CloudRequest -myURL $myURL -headers $headers).data

$myURL = 'https://api.cloud.com/healthdata/connectivitydata'
(Invoke-CloudRequest -myURL $myURL -headers $headers)
